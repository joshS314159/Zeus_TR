package edu.sru.thangiah.zeus.QAHeuristics.Selection;
...
public Shipment getSelectShipment(final DepotLinkedList depotsList, final Depot theDepot,
	...
	Shipment temp = shipmentsList.getHead().getNext(); //point to the first shipment
