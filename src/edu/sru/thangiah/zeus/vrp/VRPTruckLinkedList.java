    ...
    if (getHead() == null) {
      ...
      while (currentTruck != null) {
        if (truck.getTruckNum() < currentTruck.getTruckNum()) {
          currentTruck.getPrevious().setNext(truck);
          truck.setPrevious(currentTruck.getPrevious());
          truck.setNext(currentTruck);
          currentTruck.setPrevious(truck);
